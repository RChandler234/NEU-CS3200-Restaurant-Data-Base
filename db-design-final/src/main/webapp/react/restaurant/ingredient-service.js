...
// TODO: find all ingredient amounts for a ingredient
export const ingredientIngredientAmounts = (id) =>
    fetch(`${INGREDIENTS_URL}/ingredientAmount/ingredients/${id}`).then(response => response.json())



// TODO: export all functions as the API to this service
export default {
  findAllIngredients, findIngredientById, deleteIngredient, createIngredient, updateIngredient, ingredientIngredientAmounts
}